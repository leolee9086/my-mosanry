...
export function useMasonryLayout({
    ...
    const processPendingUpdatesLocal = () => {
        ...
        // 使用抽离出的纯函数
        const { updatedColumns, hasChanges } = processMasonryHeightUpdates({
    ...
    // 监听 items 数组变化
    setupItemsWatch(items, appendItems, rebuildLayout, idKey);
